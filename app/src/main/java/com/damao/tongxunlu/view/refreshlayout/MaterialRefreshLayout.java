...
public class MaterialRefreshLayout extends FrameLayout {
     ...
     * 是否有最小刷新高度
     */
    private boolean isMinfresh = false;
    private int minfreshHeight = 0;
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        isMinfresh = t.getBoolean(R.styleable.MaterialRefreshLayout_min_refresh, false);
        int minfreshHeightId = t.getResourceId(R.styleable.MaterialRefreshLayout_min_refresh_height, R.dimen.ayp_min_fresh_height);
        minfreshHeight = getResources().getDimensionPixelSize(minfreshHeightId);
    ...
    protected void onAttachedToWindow() {
        ...
        if (isSunStyle) {
            ...
            wcLayout.setVisibility(View.GONE);
            setHeaderView(wcLayout);
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (dy > 0 && !canChildScrollUp()) {
                    ...
                    // 当设置有最小刷新高度时，当前高度必须大于最小高度才能刷新
                    if (isMinfresh) {
                        if (getTop() < minfreshHeight) {
                    ...
                    } else if (wcLayout != null) {
                        wcLayout.setVisibility(View.VISIBLE);
                        wcLayout.onBegin(this);
                    }
//                    if (mMaterialHeaderView != null) {
//                        mMaterialHeaderView.setVisibility(View.VISIBLE);
//                        mMaterialHeaderView.onBegin(this);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mChildView != null) {
                    ...
                    if (mMaterialHeaderView != null) {
                        ...
                        wcLayout.getLayoutParams().height = (int) offsetY;
                        wcLayout.requestLayout();
                        wcLayout.onPull(this, fraction);
                    }
//                    if (mMaterialHeaderView != null) {
//                        mMaterialHeaderView.getLayoutParams().height = (int) offsetY;
//                        mMaterialHeaderView.requestLayout();
            ...
            case MotionEvent.ACTION_UP:
                if (mChildView != null) {
                    if (mMaterialHeaderView != null) {
                        ...
                        if (isOverlay) {
                            if (wcLayout.getLayoutParams().height > mHeadHeight) {

                                updateListener();

                                wcLayout.getLayoutParams().height = (int) mHeadHeight;
                                wcLayout.requestLayout();

                            } else {
                                wcLayout.getLayoutParams().height = 0;
                                wcLayout.requestLayout();
                            }
                            ...
                            if (ViewCompat.getTranslationY(mChildView) >= mHeadHeight) {
                                ...
                                createAnimatorTranslationY(mChildView, 0, wcLayout);
                            }
                        }
                    }
//                    else if (mSunLayout != null) {
...
//                    }
    ...
    public void updateListener() {
        ...
        if (mMaterialHeaderView != null) {
            ...
            wcLayout.onRefreshing(MaterialRefreshLayout.this);
        }
//        if (mMaterialHeaderView != null) {
//            mMaterialHeaderView.onRefreshing(MaterialRefreshLayout.this);
//        } else if (mSunLayout != null) {
    ...
    public void finishRefreshing() {
        if (mChildView != null) {
            ...
            if (mMaterialHeaderView != null) {
                ...
                wcLayout.onComlete(MaterialRefreshLayout.this);
            }
//            if (mMaterialHeaderView != null) {
//                mMaterialHeaderView.onComlete(MaterialRefreshLayout.this);
//            } else if (mSunLayout != null) {
