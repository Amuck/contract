...
/**
 * Created by chenlong on 2017/12/12.
 * 开标前提醒，对系统日历进行数据插入
 */
public class CalendarRemindUtil {
    ...
    private static String CALENDARS_NAME = "wcjr";
    private static String CALENDARS_ACCOUNT_NAME = "www.jinrongweb.com";
    private static String CALENDARS_ACCOUNT_TYPE = "com.android.exchange";
    private static String CALENDARS_DISPLAY_NAME = "网筹金融";
